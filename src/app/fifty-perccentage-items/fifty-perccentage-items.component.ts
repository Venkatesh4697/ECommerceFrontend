...
@Component({
  selector: 'app-fifty-perccentage-items',
  templateUrl: './fifty-perccentage-items.component.html',
  styleUrls: ['./fifty-perccentage-items.component.css']
})
export class FiftyPerccentageItemsComponent implements OnInit {
  ...
  // public cartDetails:Array<any>;
  ngOnInit(): void {
    this.productService.fetchDealItems(33).subscribe((result: any) => {
      if (result) {
        console.log("success");
        console.log(result);
        this.deals = result;
