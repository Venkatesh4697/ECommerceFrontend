...
@Component({
  selector: 'app-clearance-items',
  templateUrl: './clearance-items.component.html',
  styleUrls: ['./clearance-items.component.css']
})
export class ClearanceItemsComponent implements OnInit {
  ...
  // public cartDetails:Array<any>;
  ngOnInit(): void {
    this.productService.fetchDealItems(11).subscribe((result: any) => {
      if (result) {
        console.log("success");
        console.log(result);
